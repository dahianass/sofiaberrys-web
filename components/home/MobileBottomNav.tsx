...
export default function MobileBottomNav() {
  ...
  const tabs = [
    ...
    { id: "whatsapp", label: "WhatsApp", icon: "chat", href: "https://wa.me/573107716085" },
  ];
  ...
  return (
    <div className="fixed bottom-0 left-0 w-full z-50 flex justify-around items-center px-4 py-3 bg-surface/90 backdrop-blur-md border-t border-outline-variant/30 shadow-lg md:hidden">
      {tabs.map((tab) => {
        ...
        const buttonClass = `flex flex-col items-center justify-center transition-all ${isActive ? "text-burgundy font-bold scale-105" : "text-on-surface-variant active:scale-90"
          }`;
